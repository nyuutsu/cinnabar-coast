...
calculateGen1Checksum :: BS.ByteString -> Int -> Int -> Word8
calculateGen1Checksum saveBytes startOffset endOffset =
  let slice = BS.take (endOffset - startOffset + 1) (BS.drop startOffset saveBytes)
  in complement (BS.foldl' (+) 0 slice)
...
calculateGen2Checksum :: BS.ByteString -> Int -> Int -> Word16
